...
ui <-{
  ...
  navbarPage(id = "navbarpage", title = tags$h4(style = "font-family:Andale Mono;font-size: 25px"), theme = "shiny.css",
    tabPanel(
      tags$div(id="hometab", tags$h4(style = "font-family:Andale Mono; font-size: 25px; color: #FFFF00", "Home")),
      br(),
      br(),
      br(),
      br(),
      br(),
             ...
             fluidRow(column(width = 12, offset = 5,tags$div(id = 'videobutton', actionButton("shown", tags$b(style="font-family:Andale Mono; font-size: 20px;", "contribute NOW"), style="color: #FFFF00; background-color: #000000; border-color: #000000")))),

      ),
    tabPanel(tags$div(id = "learnmenu",tags$h4(style = "font-family:Andale Mono;font-size: 25px; color: #FFFF00", "Learn")),
    ...
    navbarMenu(tags$div(id="donatemenu", tags$h4(style = "font-family:Andale Mono;font-size: 25px; color: #FFFF00", "Donate")),
               
               "----",
               tabPanel(tags$h4(style = "font-family:Andale Mono;font-size: 18px; color: #000000;background-color: #FFFF00", "Organizations/Initiatives"),
                        tags$i(tags$h4(style = "font-family:Andale Mono;font-size: 18px; color: #FFFF00", "The names change but the color doesn't"))),
               "----",
               tabPanel(tags$h4(style = "font-family:Andale Mono;font-size: 18px; color: #000000;background-color: #FFFF00", "Bail Funds")),
               "----",
               tabPanel(tags$h4(style = "font-family:Andale Mono;font-size: 18px; color: #000000;background-color: #FFFF00", "Rebuilding Funds")),
               "----"),
    navbarMenu(tags$div(id="moremenu", tags$h4(style = "font-family:Andale Mono;font-size: 25px; color: #FFFF00", "More")),
               "----",
               tabPanel(tags$h4(style = "font-family:Andale Mono;font-size: 18px; color: #000000;background-color: #FFFF00", "Additional Resources")),
               "----",
               tabPanel(tags$h4(style = "font-family:Andale Mono;font-size: 18px; color: #000000;background-color: #FFFF00", "Feedback")),
               "----",
               tabPanel(tags$h4(style = "font-family:Andale Mono;font-size: 18px; color: #000000;background-color: #FFFF00", "Proof of Donation"),
